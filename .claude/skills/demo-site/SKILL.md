...
3. If no task found:
   ...
   - Suggest checking with `/managing-demo-site status`
...
2. If not running, report error with suggestion: "Demo site not running. Start it with `/managing-demo-site start`"
...
2. If not running, report error: "Demo site not running. Start it with `/managing-demo-site start`"
