...
be rewritten to the target `vN`: `.worktreeinclude` (demo path `demos/v18/`). Leaving `v18` in place
makes worktrees use the wrong branch prefix and PRs target the wrong `vN/dev` base.
