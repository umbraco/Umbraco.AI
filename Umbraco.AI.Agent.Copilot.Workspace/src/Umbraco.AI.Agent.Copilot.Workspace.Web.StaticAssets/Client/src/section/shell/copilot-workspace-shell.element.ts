...
export class UaiCopilotWorkspaceShellElement extends UmbLitElement implements UmbSectionElement {
    ...
    private _routes: UmbRoute[] = [
        {
            // Must precede "conversation/:id" so "create" isn't captured as an id. Starts a draft —
            // no conversation is persisted until the first message is sent (see the chat context).
