...
public static class UmbracoBuilderExtensions
{
    ...
    public static IUmbracoBuilder AddUmbracoAICopilotWorkspaceWeb(this IUmbracoBuilder builder)
    {
        ...
        builder.WithUmbracoAIManagementApi(CopilotWorkspaceConstants.ManagementApi.ApiName, options =>
        {
            options.SwaggerDoc(
                CopilotWorkspaceConstants.ManagementApi.ApiName,
                new OpenApiInfo
                {
                    Title = CopilotWorkspaceConstants.ManagementApi.ApiTitle,
                    Version = "Latest",
                    Description = "Describes the Umbraco AI Copilot Workspace Management API for conversations, " +
