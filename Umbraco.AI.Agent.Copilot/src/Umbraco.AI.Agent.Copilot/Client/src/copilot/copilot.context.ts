...
export class UaiCopilotContext extends UmbControllerBase implements UaiChatContextApi {
    ...
    constructor(host: UmbControllerHost) {
        ...
        this.#starterPrompts = new UaiStarterPromptsController(host, {
            ...
            // The repository's own list, filtered by copilot surface membership and live section/entity
            // scope, but never carrying the synthetic "Auto" option -- so it doubles as both the "is a
            // real agent selected" check and the Auto-mode merge source. No new availability logic.
