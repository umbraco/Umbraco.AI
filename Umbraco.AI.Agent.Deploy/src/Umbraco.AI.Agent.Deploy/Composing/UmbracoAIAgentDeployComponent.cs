...
/// <summary>
/// Component for registering Umbraco AI Agent Deploy disk entity types.
/// </summary>
public class UmbracoAIAgentDeployComponent(IDiskEntityService diskEntityService) : IAsyncComponent
{
    /// <inheritdoc />
