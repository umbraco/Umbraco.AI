 ...
 */
@customElement("uai-agent-status")
export class UaiAgentStatusElement extends UmbLitElement {
    ...
    override render() {
        ...
        const showLoader = this.state.status === "thinking" || this.state.status === "executing";
