import type { ManifestUaiAgentApprovalElement } from "../extensions/uai-agent-approval-element.extension.js";
...
const defaultApprovalManifest: ManifestUaiAgentApprovalElement = {
    ...
    element: () => import("../components/approval/default.element.js"),
    meta: {
...
export const manifests = [defaultApprovalManifest];
