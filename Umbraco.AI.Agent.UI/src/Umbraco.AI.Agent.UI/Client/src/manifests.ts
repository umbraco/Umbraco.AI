...
import { UAI_REQUEST_CONTEXT_SURFACE_KIND_MANIFEST } from "./chat/extensions/uai-request-context-surface-kind.extension.js";
...
export const manifests: Array<UmbExtensionManifest | UmbExtensionManifestKind> = [
    ...
    UAI_REQUEST_CONTEXT_SURFACE_KIND_MANIFEST,
    ...approvalManifests,
