...
/**
 * Workspace view for Agent info.
 * Displays metadata (read-only) and version history.
 */
@customElement("uai-agent-info-workspace-view")
export class UaiAgentInfoWorkspaceViewElement extends UmbLitElement {
...
export default UaiAgentInfoWorkspaceViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-agent-info-workspace-view": UaiAgentInfoWorkspaceViewElement;
    }
}
