...
import { UAI_ORCHESTRATION_ICON } from "../../../constants.js";
import { UAI_EDIT_ORCHESTRATION_WORKSPACE_PATH_PATTERN } from "../../../workspace/orchestration/paths.js";

/**
 * Table view for the Orchestration collection.
 */
@customElement("uai-orchestration-table-collection-view")
export class UaiOrchestrationTableCollectionViewElement extends UmbLitElement {
    @state()
    ...
    #collectionContext?: UmbDefaultCollectionContext<UaiOrchestrationItemModel>;
    ...
    #observeCollectionItems() {
        ...
        this.observe(
            ...
            (items) => this.#createTableItems(items as UaiOrchestrationItemModel[]),
    ...
    #createTableItems(items: UaiOrchestrationItemModel[]) {
            ...
            data: [
                {
                    columnAlias: "name",
                    value: html`<a
                        href=${UAI_EDIT_ORCHESTRATION_WORKSPACE_PATH_PATTERN.generateAbsolute({
                            unique: item.unique,
                        })}
                        >${item.name}</a
                    >`,
...
export default UaiOrchestrationTableCollectionViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-orchestration-table-collection-view": UaiOrchestrationTableCollectionViewElement;
    }
}
