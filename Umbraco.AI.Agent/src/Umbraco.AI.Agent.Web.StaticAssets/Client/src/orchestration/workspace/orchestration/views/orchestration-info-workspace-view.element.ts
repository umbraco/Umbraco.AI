...
/**
 * Workspace view for Orchestration info.
 * Displays metadata (read-only) and version history.
 */
@customElement("uai-orchestration-info-workspace-view")
export class UaiOrchestrationInfoWorkspaceViewElement extends UmbLitElement {
...
export default UaiOrchestrationInfoWorkspaceViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-orchestration-info-workspace-view": UaiOrchestrationInfoWorkspaceViewElement;
    }
}
