...
/// <summary>
/// Component for registering Umbraco AI Prompt Deploy disk entity types.
/// </summary>
public class UmbracoAIPromptDeployComponent(IDiskEntityService diskEntityService) : IAsyncComponent
{
    /// <inheritdoc />
