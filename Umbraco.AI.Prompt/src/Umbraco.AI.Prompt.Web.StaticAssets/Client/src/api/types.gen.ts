...
export type PromptExecutionRequestModel = {
    ...
    culture?: null | string;
    segment?: null | string;
    context?: null | Array<RequestContextItemModel>;
};
...
export type ResultOptionModel = {
    ...
    displayValue: string;
    description?: null | string;
    valueChange?: null | ValueChangeModel;
};
...
export type ScopeRuleModel = {
    propertyEditorUiAliases?: null | Array<string>;
    propertyAliases?: null | Array<string>;
    contentTypeAliases?: null | Array<string>;
};
