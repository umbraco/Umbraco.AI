 ...
 */
export const UAI_PROMPT_PREVIEW_MODAL = new UmbModalToken<UaiPromptPreviewModalData, UaiPromptPreviewModalValue>(
 ...
 */
export const UAI_PROMPT_PREVIEW_SIDEBAR = new UmbModalToken<UaiPromptPreviewModalData, UaiPromptPreviewModalValue>(
    UAI_PROMPT_PREVIEW_MODAL_ALIAS,
    {
        modal: {
            type: "sidebar",
