...
/// <summary>
/// An image-generator decorator that sets profile metadata in the runtime context per-execution.
/// </summary>
/// <remarks>
/// <para>
/// This generator wraps a base <see cref="IImageGenerator"/> and automatically populates runtime context
/// with profile metadata (ProfileId, ProfileAlias, ProviderId, ModelId) whenever a generation operation
/// is executed.
/// </para>
/// <list type="bullet">
...
/// </list>
/// </remarks>
internal sealed class ScopedProfileImageGenerator : AIBoundImageGeneratorBase
{
    ...
    public ScopedProfileImageGenerator(
