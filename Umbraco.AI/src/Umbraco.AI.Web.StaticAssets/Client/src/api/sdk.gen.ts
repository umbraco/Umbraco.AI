...
export class ProfilesService {
    ...
    public static aliasExists2<ThrowOnError extends boolean = false>(options: Options<AliasExists2Data, ThrowOnError>) {
        return (options.client ?? client).get<AliasExists2Responses, AliasExists2Errors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
