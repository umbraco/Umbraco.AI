...
import type { DecisionQuestionModel, DecisionResponseModel } from "../../api/types.gen.js";
import type { UaiDecisionQuestion, UaiDecisionRequest, UaiDecisionResult } from "../types.js";

function toQuestionModel(question: UaiDecisionQuestion): DecisionQuestionModel {
...
function toResult(response: DecisionResponseModel): { data?: UaiDecisionResult; error?: unknown } {
