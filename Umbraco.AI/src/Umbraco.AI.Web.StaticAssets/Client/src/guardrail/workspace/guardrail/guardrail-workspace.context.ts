...
import { UaiGuardrailWorkspaceEditorElement } from "./guardrail-workspace-editor.element.js";
...
/**
 * Workspace context for editing Guardrail entities.
 * Handles CRUD operations, state management, and command tracking.
 */
export class UaiGuardrailWorkspaceContext
    extends UmbSubmittableWorkspaceContextBase<UaiGuardrailDetailModel>
    implements UmbRoutableWorkspaceContext
{
    ...
    #model = new UmbObjectState<UaiGuardrailDetailModel | undefined>(undefined);
    readonly model = this.#model.asObservable();

    #repository: UaiGuardrailDetailRepository;
    ...
    constructor(host: UmbControllerHost) {
        super(host, UAI_GUARDRAIL_WORKSPACE_ALIAS);

        this.#repository = new UaiGuardrailDetailRepository(this);
        this.#validationContext = new UmbValidationContext(this);
        this.addValidationContext(this.#validationContext);

        this.#entityContext.setEntityType(UAI_GUARDRAIL_ENTITY_TYPE);
        this.observe(this.unique, (unique) => this.#entityContext.setUnique(unique ?? null));

        this.routes.setRoutes([
            {
                path: "create",
                component: UaiGuardrailWorkspaceEditorElement,
                setup: async () => {
                    await this.scaffold();
            ...
            },
            {
                ...
                setup: (_component, info) => {
                    ...
                    new UaiEntityDeletedRedirectController(this, {
                        ...
                        collectionPath: UAI_GUARDRAIL_ROOT_WORKSPACE_PATH,
                    });
                },
            },
        ]);
    ...
    /**
     * Loads an existing guardrail by ID.
     */
    ...
    getData(): UaiGuardrailDetailModel | undefined {
    ...
    getEntityType(): string {
        return UAI_GUARDRAIL_ENTITY_TYPE;
    }

    /**
     * Saves the guardrail (create or update).
     */
    async submit() {
...
export { UaiGuardrailWorkspaceContext as api };
