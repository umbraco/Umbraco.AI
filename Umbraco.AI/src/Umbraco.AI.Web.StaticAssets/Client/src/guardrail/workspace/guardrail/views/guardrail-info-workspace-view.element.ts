...
/**
 * Workspace view for Guardrail info.
 * Displays metadata (read-only) and version history.
 */
@customElement("uai-guardrail-info-workspace-view")
export class UaiGuardrailInfoWorkspaceViewElement extends UmbLitElement {
...
export default UaiGuardrailInfoWorkspaceViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-guardrail-info-workspace-view": UaiGuardrailInfoWorkspaceViewElement;
    }
}
