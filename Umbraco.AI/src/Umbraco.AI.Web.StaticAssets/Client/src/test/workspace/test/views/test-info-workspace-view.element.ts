...
/**
 * Workspace view for Test info.
 * Displays metadata (read-only) and version history.
 */
@customElement("uai-test-info-workspace-view")
export class UaiTestInfoWorkspaceViewElement extends UmbLitElement {
...
export default UaiTestInfoWorkspaceViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-test-info-workspace-view": UaiTestInfoWorkspaceViewElement;
    }
}
