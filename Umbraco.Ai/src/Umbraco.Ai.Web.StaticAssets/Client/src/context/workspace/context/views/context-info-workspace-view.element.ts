...
/**
 * Workspace view for Context info.
 * Displays metadata (read-only) and version history.
 */
@customElement("uai-context-info-workspace-view")
export class UaiContextInfoWorkspaceViewElement extends UmbLitElement {
...
export default UaiContextInfoWorkspaceViewElement;

declare global {
    interface HTMLElementTagNameMap {
        "uai-context-info-workspace-view": UaiContextInfoWorkspaceViewElement;
    }
}
