...
import { UAI_EDIT_TEST_WORKSPACE_PATH_PATTERN } from "../../../workspace/test/paths.js";
        ...
        this._items = items.map((item) => ({
            ...
            data: [
                ...
                },
                {
                    ...
                    value: html`<uui-tag color="primary" look="outline">${item.testTypeId}</uui-tag>`,
                },
                {
                    columnAlias: "status",
                    value: item.isEnabled
                        ? html`<uui-tag color="positive" look="outline">Enabled</uui-tag>`
                        : html`<uui-tag color="default" look="outline">Disabled</uui-tag>`,
                },
                {
