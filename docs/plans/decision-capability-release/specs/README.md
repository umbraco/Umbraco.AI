...
| T14 | `Umbraco.AI/src/Umbraco.AI.Web.StaticAssets/Client/src/decision/**/*.test.ts` |
| T15 | `.../Client/src/settings/**/*.test.ts` |
| T16 | `.../Client/src/profile/workspace/profile/views/settings/decision-profile-settings.element.test.ts`, `.../Client/src/lang/en.test.ts` |
| T18 | `Umbraco.AI.Deploy/tests/Umbraco.AI.Deploy.Tests.Unit/Connectors/ServiceConnectors/DecisionDeployTests.cs` |
