...
The Semantic Search add-on (`Umbraco.AI.Search`) adds AI-powered vector search to Umbraco. It indexes content as vector embeddings and supports similarity search through both the CMS Search API and an AI agent tool.
