...
A capability represents a type of AI operation. Providers implement capabilities to expose their features, and profiles are configured for a specific capability.
