...
A context is a collection of resources that provide additional information to AI operations. Contexts enable you to maintain consistent brand voice, inject guidelines, or include relevant content (like RAG data) into every AI request.
...
1. **Consistency** - Maintain brand voice across all AI interactions
2. **Separation** - Keep guidelines separate from business logic
3. **Reusability** - Share the same context across multiple profiles
4. **Manageability** - Update guidelines without code changes
5. **RAG Support** - Inject relevant content for retrieval-augmented generation
