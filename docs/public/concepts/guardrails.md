...
| `data-protection`    | GDPR compliance         | PII pre-generate (Redact), PII post (Redact)|
...
| ------------ | ----------- | ---------- | ------ | ----------------------------------------------------------------- |
| PII          | `pii`       | Code-based | Yes    | Regex patterns for emails, phone numbers, SSNs, credit cards      |
