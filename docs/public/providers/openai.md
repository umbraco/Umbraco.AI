...
OpenAI provides access to GPT models for chat and text-embedding models for semantic search. This is the most widely-used provider with comprehensive model selection.
