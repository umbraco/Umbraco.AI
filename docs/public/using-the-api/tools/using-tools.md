---
description: >-
    Give AI models the ability to call functions using the M.E.AI tool system.
---

# Using Tools

Tools allow AI models to call functions during a conversation. The model decides when to use a tool based on the user's request, and the tool results are fed back into the conversation for the model to formulate its final response.
