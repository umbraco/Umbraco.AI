...
/// <summary>
/// Service implementation for processing agent definitions with variable replacement.
/// </summary>
internal sealed partial class AiAgentTemplateService : IAiAgentTemplateService
{
