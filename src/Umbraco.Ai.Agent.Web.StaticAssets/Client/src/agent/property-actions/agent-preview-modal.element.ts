...
import { UAiAgentController } from '../controllers/prompt.controller.js';
...
export class UAiAgentPreviewModalElement extends UmbModalBaseElement<
    UAiAgentPreviewModalData,
    UAiAgentPreviewModalValue
> {
    #promptController = new UAiAgentController(this);
...
export default UAiAgentPreviewModalElement;

declare global {
    interface HTMLElementTagNameMap {
        'uai-prompt-preview-modal': UAiAgentPreviewModalElement;
    }
}
