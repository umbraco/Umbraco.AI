...
import type { UAiAgentScope } from './types.js';

/**
 * Condition configuration for prompt scope filtering.
 */
export interface UAiAgentScopeConditionConfig extends UmbConditionConfigBase {
 ...
 */
export class UAiAgentScopeCondition
    extends UmbConditionBase<UAiAgentScopeConditionConfig>
    implements UmbExtensionCondition
{
    ...
    constructor(host: UmbControllerHost, args: UmbConditionControllerArguments<UAiAgentScopeConditionConfig>) {
        super(host, args);
...
export { UAiAgentScopeCondition as api };
