...
import { UAiAgentDetailServerDataSource } from "./prompt-detail.server.data-source.js";
...
export class UAiAgentDetailRepository extends UmbDetailRepositoryBase<UAiAgentDetailModel> {
    constructor(host: UmbControllerHost) {
        super(host, UAiAgentDetailServerDataSource, UAI_PROMPT_DETAIL_STORE_CONTEXT);
    }
