...
/// <summary>
/// Represents a governance audit record for an AI operation, capturing execution details,
/// user context, and outcomes for audit and observability purposes.
/// </summary>
public sealed class AiAudit
{
    /// <summary>
    /// Gets the unique identifier for this audit in the local database.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the execution status of this audit.
    /// </summary>
    public AiAuditStatus Status { get; set; }

    /// <summary>
    /// Gets or sets the error category, if the operation failed.
    /// </summary>
    public AiAuditErrorCategory? ErrorCategory { get; set; }
    ...
    /// <summary>
    /// Gets the detail level configured for this audit.
    /// </summary>
    public AiAuditDetailLevel DetailLevel { get; init; }

    /// <summary>
    /// Gets the execution Activities associated with this audit.
    /// </summary>
    public IReadOnlyList<AiAuditActivity> Activities { get; internal set; } = Array.Empty<AiAuditActivity>();
}
