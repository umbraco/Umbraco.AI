...
public class AiGovernanceOptions
{
    ...
    /// <summary>
    /// Gets or sets the number of days to retain trace records before cleanup.
    /// Default is 14 days.
    /// </summary>
    public int RetentionDays { get; set; } = 14;

    /// <summary>
    /// Gets or sets the detail level for capturing trace information.
    /// Default is FailuresOnly.
    /// </summary>
    public AiTraceDetailLevel DetailLevel { get; set; } = AiTraceDetailLevel.FailuresOnly;
