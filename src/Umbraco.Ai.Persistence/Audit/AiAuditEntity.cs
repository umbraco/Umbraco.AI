...
/// <summary>
/// EF Core entity for AI audit records.
/// </summary>
public class AiAuditEntity
{
    ...
    /// <summary>
    /// Gets or sets the OpenTelemetry audit ID (hex string).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the execution Activities associated with this audit.
    /// </summary>
    public ICollection<AiAuditActivityEntity> Activities { get; set; } = new List<AiAuditActivityEntity>();
}
