...
public static class UmbracoBuilderExtensions
{
    ...
    public static IUmbracoBuilder AddUmbracoAiPersistence(this IUmbracoBuilder builder)
    {
        ...
        builder.Services.AddSingleton<IAiAuditRepository, EfCoreAiAuditRepository>();
        builder.Services.AddSingleton<IAiAuditActivityRepository, EfCoreAiAuditActivityRepository>();
