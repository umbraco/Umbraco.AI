...
public class AllProfileController : ProfileControllerBase
{
    ...
    /// </summary>
    public AllProfileController(IAiProfileRepository profileRepository, IUmbracoMapper umbracoMapper)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            profiles = await _profileRepository.GetByCapability(cap, cancellationToken);
        }
        else
        {
